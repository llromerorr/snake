...
//FUNCIONES
        ...
        void Cambio_de_Pantalla()
        {
            ...
            for (int i = 1; i <= 2; i++)                                //Efecto de Intro
            {
                for (int yIntro = 1; yIntro <= 25; yIntro++)
                    {
                    for (int i = 1; i <= 60; i++){y = yIntro ;gotoxy(i, yIntro);printf("%c", 219);}
                    Sleep(1);
                    }
        ...
        {
            char q;
            while (Game_Over==false){if(kbhit()){q=getch(); printf("%d",q);}}

        }

        void Pintar_Cuerpo()
        {
            gotoxy(CabezaX,CabezaY);printf("o");                         //IMPRIMRIR CABEZA        
        }

        void tocar_boton()
        {  
        
            if(kbhit()){boton=getch();                                   //CAMBIAR DIRECCION AL TOCAR BOTON
                    if (boton==ARRIBA && dir!=3) dir = 1;
                    if (boton==DERECHA && dir!=4) dir = 2;
                    if (boton==ABAJO && dir!=1) dir = 3;
                    if (boton==IZQUIERDA && dir!=2) dir = 4;}
        ...
        {    
                ...
                //gotoxy(1,1);cout<<"CabezaX: "<<Ubicacion_Cuerpo[0][n]<<endl;
                //gotoxy(1,2);cout<<"Cabezay: "<<Ubicacion_Cuerpo[1][n]<<endl;
                //gotoxy(1,3);cout<<"n: "<<n<<endl;
        ...
        void Borrar_Cuerpo()
        {
            gotoxy(Ubicacion_Cuerpo[0][e],Ubicacion_Cuerpo[1][e]); printf(" ");
            Ubicacion_Cuerpo[0][e] = 0;Ubicacion_Cuerpo[1][e]=0;
            //gotoxy(1,4);cout<<"e: "<<e<<endl;
            if(e>tam) e=0; e++;
        }
        ...
        {
            int a=1;while(a<=tam)
            {if(Ubicacion_Cuerpo[0][a]==CabezaX && Ubicacion_Cuerpo[1][a]==CabezaY) {Game_Over=true;}
            a++;
           }

            if (CabezaX==1 || CabezaX==60 || CabezaY == 6 || CabezaY == 25) {Game_Over = true;}
        ...
        void Comida_Generador ()
        {
            ...
            if(ComidaX == CabezaX && ComidaY == CabezaY){
                ...
                ComidaY = (rand() % 17) + 7;
                tam++;
                gotoxy(ComidaX,ComidaY); printf("%c", 254);
                point=point+10;}

            else {gotoxy(ComidaX,ComidaY); printf("%c", 254);}
        ...
        void HUD()
        {
            ...
            //gotoxy(1,4); cout<<"Durabilidad: "<<Durabilidad_Contador;
                if(Durabilidad_Contador>=0){
                    gotoxy(30,1);cout<<"                ";
                    Durabilidad++ ; gotoxy(40,1);cout<<"Resistente x"<<Durabilidad;
        ...
        {
            Game_Over=false;
            dir = 2; CabezaX = 50; CabezaY = 12;
            tam = 4;
            n=1, e=2; //Bucles
            ComidaX=20; ComidaY=20;
            point = 0;

            int av=1;while(av<=tam)
    ...
    Juego_Nivel0()
    {
        ...
        Movimiento_Automatico();
            ...
            if(Game_Over == true) 
            {
                ...
                /*switch(Dificultad_Hud){
                case 1: gotoxy(28,17);cout<<"Dif:     Facil"; break;
                case 2: gotoxy(28,17);cout<<"Dif:     Normal"; break;
                case 3: gotoxy(28,17);cout<<"Dif:     Dificil"; break;
                case 4: gotoxy(28,17);cout<<"Modo Destruccion"; break;}*/

                gotoxy (28,14); printf("Score: %d",point);
                //gotoxy (28,19); printf("Rest:    x%d",Durabilidad);
                getch();
            }
            getch();
            getch();
...
//PANTALLAS
    ...
    void Menu_Dificultad()
    {
            ...
            //Escoger Opcion-----------------------------------------------------------------------------------
                ...
                while(Escoger==false)
                    {
                        if(kbhit()){Selecion_Menu_Dificultad=getch();                                
                            if (Selecion_Menu_Dificultad==ARRIBA) Objetivo_Seleccion_Menu_Dificultad--;
                            if (Selecion_Menu_Dificultad==ABAJO) Objetivo_Seleccion_Menu_Dificultad++;
                            if (Selecion_Menu_Dificultad==ENTER) Escoger=true;
                    }
                    
                    
                switch(Objetivo_Seleccion_Menu_Dificultad)
                    {
                        case 1: gotoxy(26,15); printf("%c%c", 62,62); 
                                    gotoxy(26,16); printf("  ");
                                    gotoxy(26,17); printf("  "); 
                                    gotoxy(26,18); printf("  "); 
                                    gotoxy(26,20); printf("  "); 
                        ...
                        case 2: gotoxy(26,16); printf("%c%c", 62,62); 
                                    gotoxy(26,15); printf("  ");
                                    gotoxy(26,17); printf("  "); 
                                    gotoxy(26,18); printf("  "); 
                                    gotoxy(26,20); printf("  "); 
                        ...
                        case 3: gotoxy(26,17); printf("%c%c", 62,62); 
                                    gotoxy(26,15); printf("  ");
                                    gotoxy(26,16); printf("  "); 
                                    gotoxy(26,18); printf("  "); 
                                    gotoxy(26,20); printf("  "); 
                        ...
                        case 4: gotoxy(26,18); printf("%c%c", 62,62); 
                                    gotoxy(26,15); printf("  ");
                                    gotoxy(26,16); printf("  "); 
                                    gotoxy(26,17); printf("  "); 
                                    gotoxy(26,20); printf("  "); 
                        ...
                        case 0: gotoxy(26,20); printf("%c%c", 62,62); 
                                    gotoxy(26,15); printf("  ");
                                    gotoxy(26,17); printf("  "); 
                                    gotoxy(26,16); printf("  "); 
                                    gotoxy(26,18); printf("  "); 
                ...
                if (Objetivo_Seleccion_Menu_Dificultad <0) Objetivo_Seleccion_Menu_Dificultad=4;
    ...
    {       
            ...
            //Escoger Opcion-----------------------------------------------------------------------------------
                int Selecion_Menu_Principal; int Objetivo_Seleccion_Menu_Principal = 0;
               
                while(Escoger==false)
                    {
                        if(kbhit()){Selecion_Menu_Principal=getch();                                
                ...
                if (Objetivo_Seleccion_Menu_Principal <0) Objetivo_Seleccion_Menu_Principal=1;
